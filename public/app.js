...
import { store } from "./lib/store.js?v=49";
...
import { renderDetail } from "./views/detail.js?v=49";
import * as board from "./views/board.js?v=49";
import * as court from "./views/court.js?v=49";
import * as ledger from "./views/ledger.js?v=49";
import * as chaos from "./views/chaos.js?v=49";
import * as metrics from "./views/metrics.js?v=49";
import * as pilot from "./views/pilot.js?v=49";
