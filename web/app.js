...
import { store } from "./lib/store.js?v=42";
...
import { renderDetail } from "./views/detail.js?v=42";
import * as board from "./views/board.js?v=42";
import * as court from "./views/court.js?v=42";
import * as ledger from "./views/ledger.js?v=42";
import * as chaos from "./views/chaos.js?v=42";
import * as metrics from "./views/metrics.js?v=42";
import * as pilot from "./views/pilot.js?v=42";
