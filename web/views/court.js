...
import { esc, $, $$, on, shortId, fmtUsd, diffChars, renderDiff } from "../lib/dom.js?v=70";
import { gsap, reduced, enter } from "../lib/motion.js";
import { fieldZh, fieldEn, strategyZh, STRATEGIES, RISK, STATE } from "../lib/copy.js";
import { card, courtFields, orderedFields, confidenceOf, ledgerRef } from "../lib/case.js?v=70";
