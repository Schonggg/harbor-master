...
import { esc, $, $$, on, shortId, diffChars, renderDiff, fmtUsd, sourceWaitHtml } from "../lib/dom.js?v=65";
...
import { card, orderedFields, pilotReasons, ledgerRef, confidenceOf } from "../lib/case.js?v=65";
import { effectiveState, present } from "../lib/field-display.js?v=65";
