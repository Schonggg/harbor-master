...
| **Ledger** | Durable memory of Pilot work. Contested pair rules replay on open Pilot mail. Case stamps are provenance only. **Revoke** peels that pair's paint off auto-closed mail and re-opens it to Pilot; human CLEAR/HOLD stamps stay put. Header counts come from Postgres. Refresh reloads the ledger; it does not wipe it. |
