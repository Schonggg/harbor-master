...
**Cache.** After a UI change, bump that `?v=` lockstep (`app.js` / `store.js` currently `?v=64`, `styles.css` `?v=45`), run `py -3 scripts/vercel_build.py`, then deploy. Do not hard-refresh only `index.html`.
